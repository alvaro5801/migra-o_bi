...
## Índice Oficial da Soberania SQL no Módulo BMB
...
1. **database_schema.sql**
   ...
   - Conteúdo: DDL SQL moderno (CREATE TABLE, VIEWS, STORED PROCEDURES)
   - Exemplo:
   ```sql
   -- Gerado por Analyzer-A [ANA-SQL]
   -- Fonte: bi14a.esf
...
3. **complexity_matrix_sql.csv**
   ...
   QRY-SQL-050,DYNAMIC,9,HIGH,UNKNOWN,UNKNOWN,UNKNOWN,TRUE,SQL dinâmico - difícil rastrear
...
5. ANALYZER-A [ANA-SQL]
   ├─ Carregar: claims_sql_A.json (validado)
...
**Resultado**:
- ✅ `database_schema.sql` gerado (150 linhas DDL)
- ✅ `data_lineage.csv` gerado (47 linhas de linhagem)
...
- [Integração VAMAP](../migracao-forense-bi/INTEGRACAO_VAMAP.md) - Âncora da Verdade
- [Especialização SQL](../migracao-forense-bi/ESPECIALIZACAO_SQL_FASE1.md) - Trilha SQL completa
- [BMB Documentation](./index.md) - Documentação do módulo BMB
