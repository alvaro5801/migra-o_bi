...
### 🆕 Soberania SQL (Isolamento de Dados)
- **[Trilha SQL](./docs/trilha-sql.md)** - 🗄️ Índice oficial da Soberania SQL
- [Base de Conhecimento SQL](./knowledge/sql/) - Regras e padrões SQL
